# Video & Chat SaaS Platform Interface

A responsive, multi-page frontend user interface designed for a modern Video Conferencing and Chat SaaS (Software-as-a-Service) platform. 

This project showcases clean HTML structure, custom layout design, navigation routing, and UI designs for dashboards, communication hubs, and public-facing marketing pages.
...
├── pricing.html        # Subscription tier mapping page
├── about.html          # Product details page
